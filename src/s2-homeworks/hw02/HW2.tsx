...
export const filterAffairs = (affairs: AffairType[], filter: FilterType): AffairType[] => {
    switch(filter) {
        case 'high': return affairs.filter(el => el.priority === 'high');
        case 'low': return affairs.filter(el => el.priority === 'low');
        case 'middle': return affairs.filter(el => el.priority === 'middle');
